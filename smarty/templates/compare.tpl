...
<input type="hidden" name="other_v_id" value="{$other_v_id}"/>
	...
	<div class="likedislike" style="position: absolute;"><span class="likeall" onclick="makeAllMergeChoices_2col('like');">A</span> R <span class="dislikeall" onclick="makeAllMergeChoices_2col('dislike');">D</span> | <span class="undoall" onclick="makeAllMergeChoices_2col('undo');">U</span></div>
		{$diff}
	</div>
	</div> <!--box content-->
</div> <!--box left_main-->
