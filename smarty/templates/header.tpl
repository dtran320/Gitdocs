...
{/literal}
 ...
 <div class="wide_header">
	...
	{if isset($logged_in_user) }
		...
		<div class="float_left logged_in_user"><a href="new_note.php">Add</a></strong> | <a href="browse.php">Browse</a> | <a href="change_avatar.php">Account</a> | Logged in as {$logged_in_user.displayName} | <a href="index.php?action=logout">Logout</a></div>
