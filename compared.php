...
<div class="box right_side">
  ...
  <li class="active"><span onclick="DisplayOthers()"><a class="active">Others' Versions</span></a></li>
       ...
       <table>
	   <tr><td><div style="float: left; padding-right:6px;"><img src="images/mlinsey.jpg" /> </div>you are now editing <b>forest2</b>, which you saved 2m ago</td></tr>
<tr><td><div style="float: right; padding-right:4px;"><img src="images/mlee.jpg" /> </div>you combined parts from mlee's <b>desc. of Edward</b> 2m ago</td></tr>
<tr><td><div style="float: left; padding-right:6px;"><img src="images/mlinsey.jpg" /> </div>you edited <b>forest2</b> 4m ago</td></tr>
<tr><td><div style="float: right; padding-right:4px;"><img src="images/dtran.jpg" /> </div>you started from dtran's <b>forest</b> 5m ago<br /></td></tr>
	...
	<table>
<tr><td><div style="float: left; padding-right:4px;"><img src="images/mlee.jpg" /> </div><a href="compare.php">new desc. of Edward</a><br />by mlee 8h ago</td></tr>
<tr><td><div style="float: left; padding-right:4px;"><img src="images/dtran.jpg" /> </div><b>forest</b><br />by dtran 1d ago</td></tr>
